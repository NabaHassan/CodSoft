...
class thirdPage extends State<third_page> {
                ...
                final documents = snapshot.data!.docs;
                  ...
                  return ListView.builder(
                     ...
                     return Container(
                       ...
                       padding: EdgeInsets.fromLTRB(0, 500, 40, 0),
  ...
  void _updateTasks(String taskId) async {
    String newTaskname = taskNameController.text;
    String newTaskdesc = taskDescController.text;

    await _firestore.collection('tasks').add({'task':newTaskname,'Desc':newTaskdesc,
      'DueDate':selectedDate ,'Priority':_selectedDropdownVal});
